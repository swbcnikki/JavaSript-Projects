...
function checkWinConditions() {
    ...
    // squares are selected the code executes.
        ...
        audio('./media/tie.mp3');
        // This function sets a .3 second timer before the resestGame is called.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        const c = selectedSquares.includes(squareC)
            // If the 3 variables we pass are all included in our array, true is returned and
            //our else if condition executes the drawWinLine funciton.
...
function audio(audioURL) {
    //We creage a new audio object and we pass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    const canvas = document.getElementById('win-lines')
        // This linegives us access to methods and properties to use on canvas.
    ...
    let x1 = coordX1,
        ...
        y = y1;
    // This fucntion interacts with the canvas
